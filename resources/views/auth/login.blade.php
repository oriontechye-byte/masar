...
<head>
  ...
  <style>
    ...
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    h1{margin-bottom:6px; font-size:1.4rem; color:var(--ink); font-weight:800; display:flex; align-items:center; justify-content:center; gap:8px}
...
<body>
  ...
  <main class="wrap">
    <div class="login-container" id="loginCard">
      <h1><i class="fas fa-user-shield"></i> لوحة تحكم مسار</h1>
