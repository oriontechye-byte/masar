...
<head>
  ...
  <style>
    ...
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    .cta-buttons{display:flex;gap:12px;justify-content:center;flex-wrap:wrap;animation:slideInUp 1s ease-out .6s both}
    .btn{padding:14px 22px;border:none;border-radius:999px;font-size:clamp(14px,3.6vw,17px);font-weight:800;cursor:pointer;transition:all .25s ease;text-decoration:none;display:inline-flex;align-items:center;gap:10px;font-family:'Cairo',sans-serif;position:relative;overflow:hidden}
    ...
    .btn-primary{background:rgba(255,255,255,.22);color:#fff;border:2px solid rgba(255,255,255,.3);backdrop-filter:blur(8px)}
    ...
    /* Trust badges */
    .trust{display:flex;gap:10px;justify-content:center;flex-wrap:wrap;margin-top:10px}
    ...
    .section-title{text-align:center;font-size:clamp(22px,5.6vw,48px);font-weight:900;color:var(--text);margin-bottom:14px;letter-spacing:.2px}
    .section-subtitle{text-align:center;font-size:clamp(14px,3.6vw,18px);color:var(--text-muted);margin-bottom:46px;max-width:680px;margin-inline:auto;line-height:1.9}

    /* Features */
    .features-section{padding:100px 0;background:var(--surface-2)}
    .features-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:22px;margin-top:22px}
    .feature-card{background:var(--surface-2);padding:28px 22px;border-radius:var(--radius);text-align:center;box-shadow:var(--shadow-md);transition:all .25s ease;position:relative;overflow:hidden;border:1px solid var(--border)}
    ...
    .feature-icon{font-size:2.6rem;color:var(--brand);margin-bottom:12px;display:block}
    .feature-title{font-size:1.25rem;font-weight:900;color:var(--text);margin-bottom:8px}
    .feature-description{color:var(--text-muted);line-height:1.9}

    /* Acknowledgments */
    .ack-section{padding:90px 0;background:var(--surface)}
    .ack-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:22px;margin-top:18px}
    ...
    .t-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:22px;margin-top:20px}
    .t-card{background:var(--surface-2);border-radius:16px;box-shadow:var(--shadow-sm);padding:18px;border:1px solid var(--border)}
    ...
    .stats-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:22px;text-align:center}
    .stat-item{padding:18px}
    .stat-number{font-size:clamp(22px,7vw,48px);font-weight:900;color:var(--brand-2);margin-bottom:6px;display:block}
    .stat-label{font-size:clamp(13px,3.6vw,17px);opacity:.92}
    ...
    .faq-q{display:flex;align-items:center;justify-content:space-between;padding:14px 16px;cursor:pointer;font-weight:900;color:var(--text)}
    .faq-q i{transition:transform .25s ease}
    .faq-item[aria-expanded="true"] .faq-q i{transform:rotate(180deg)}
    .faq-a{max-height:0;opacity:0;overflow:hidden;transition:all .3s ease;padding:0 16px}
    .faq-item[aria-expanded="true"] .faq-a{max-height:300px;opacity:1;padding:0 16px 14px}
    .faq-a p{line-height:1.9;color:var(--text-muted)}

    /* Footer */
    .footer{background:var(--footer-bg);color:#fff;padding:60px 0 30px}
    .footer-nav-tags{text-align:center;margin-bottom:34px}
    .footer-nav-tags h3{font-size:1.2rem;font-weight:800;margin-bottom:16px;color:var(--brand-2)}
    .nav-tags{display:flex;justify-content:center;gap:10px;flex-wrap:wrap}
    .nav-tag{background:#34495e;color:#fff;padding:8px 14px;border-radius:25px;text-decoration:none;font-weight:800;font-size:.95rem;transition:all .25s ease;border:2px solid transparent}
    .nav-tag:hover{background:var(--brand-2);color:#2c3e50;transform:translateY(-2px);box-shadow:0 5px 15px rgba(243,156,18,.3)}
    .footer-content{display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:24px;margin-bottom:26px}
    .footer-section h3{font-size:1.05rem;font-weight:900;margin-bottom:12px;color:var(--brand-2)}
    ...
    .footer-section li{margin-bottom:8px;display:flex;align-items:center}
    .footer-section li i{margin-left:8px;color:var(--brand-2);width:20px;text-align:center}
    ...
    .footer-bottom{text-align:center;padding-top:20px;border-top:1px solid #34495e;color:var(--footer-text)}
    .footer-bottom .note{margin-top:6px;display:block}
    ...
    <p>
      ...
      لبناء جيل واعٍ ومؤهل أكاديميًّا ومهنيًّا.
          ...
          <article class="ack-card fade-in" id="team">
            ...
            <div class="ack-body">
              <p>الأعضاء: أحمد القباطي، عمر النهمي، عبدالغني الغانمي.</p>
            </div>
          </article>
        </div>
      </div>
